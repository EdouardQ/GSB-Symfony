 ...
 */
final class Version20210403184720 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE expense_bundle (id INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(50) NOT NULL, montant NUMERIC(5, 2) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE line_expense_bundle (id INT AUTO_INCREMENT NOT NULL, expense_form_id INT NOT NULL, expense_bundle_id INT NOT NULL, quantite INT NOT NULL, date DATE DEFAULT NULL, INDEX IDX_5722D10032EDD047 (expense_form_id), INDEX IDX_5722D100355DF2A9 (expense_bundle_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE state (id INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
